...
button_play = create_button("Play", 200, display_get_gui_height() - 20, 120, 30, false, c_rainbow, false);
button_settings = create_button("Settings", display_get_gui_width() / 2, display_get_gui_height() - 20, 120, 30, false, c_rainbow, false);
button_quit = create_button("Quit", display_get_gui_width() - 200, display_get_gui_height() - 20, 120, 30, false, c_rainbow, false);
